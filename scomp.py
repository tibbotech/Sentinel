...
CMD_WRITE_READ      = ord('C') # 0x03      # Combined write-then-read in one bus transaction
CMD_END             = ord('.') # 0xFF
...
class register:
    """Class represents ModBus register number. Can be used only in modbus-driven sensors
    """
    __slots__ = ["number", "type", "datatype"]
